...
<style>
        ...
        .app-container {{
            background-image: 
                radial-gradient(circle, rgba(129, 236, 255, 0.9) 0.8px, transparent 3px),
                radial-gradient(circle, rgba(129, 236, 255, 0.2) 3px, transparent 12px),
...
<body>
    <div class="app-container flex flex-col gap-6">
