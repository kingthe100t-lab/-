...
dep_curve_16 = [
    ...
    [33.579172885448706, 130.45531520290436], 
    [33.564304341775988, 130.46693597355616], # ←追加：2点目と3点目の「ど真ん中」の座標
    [33.54943579810327, 130.47855674420796]
]
dep_path_16 = create_smooth_path(dep_curve_16, 60)

dep_curve_34 = [
    [rwy16_pos[0], rwy16_pos[1]], # RWY34離陸（北へ向かって海へ抜ける）
    [33.59444398997148, 130.44502712636253],
    [33.61313762168786, 130.430864215359],    # ←追加：2点目と3点目の「ど真ん中」の座標
    [33.63183125340424, 130.41670130435546]
]
