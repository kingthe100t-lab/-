...
# ※ここにあった「案内文言（st.info）」は完全に削除しました！
...
with col_map:
    ...
    # ※ここで起きていた文法エラー（dash_array）を完全に修正しました
    AntPath(
    ...
    plane_angle = 160 if current_rwy == "16" else 340 
